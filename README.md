...
[![My Skills](https://skillicons.dev/icons?i=html,htmx,css,js,react,vite,vue,ts,python,cpp,php,sass,bootstrap,tailwind,less,pug,bots,regex,git,github,gitlab,netlify,md,notion,npm,ps,ai,ae,pr,blender,pycharm,sublime,vscode,webstorm,figma,bash,codepen,linux,kali,phpstorm,atom,babel,d3,discord,mongodb,nextjs,nodejs,nuxtjs,visualstudio,vitest&perline=13)](#)
